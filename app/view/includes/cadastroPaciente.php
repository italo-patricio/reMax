...
placeholder="Dia/Mês/Ano" class="form-control">
...
placeholder="Informe o nome do esposo(a)" class="form-control">
...
o Trabalho do paciente" class="form-control">
...
emissor da identidade" class="form-control">
...
<input id="textinput" name="textinput" type="text"
placeholder="Informe onde o paciente nasceu" class="form-control">
...
<input id="textinput" name="textinput" type="text" placeholder="Informe seu CEP" class="form-control">
...
<input id="textinput" name="textinput" type="text"
placeholder="Número residencial" class="form-control">
...
<input id="textinput" name="textinput" type="text"
placeholder="nome@example.com" class="form-control">
